...
const ASSETS_TO_PRELOAD = [
  '/logo/meo_mix_logo.webp',
  '/logo/meo_mix_logo_white.webp',
  '/logo/Fruits.webp',
  '/products/mango_bottle.webp',
  '/products/lychee_bottle.webp',
  '/products/orange_bottle.webp',
  '/products/pineapple_bottle.webp',
  '/products/pink_guava_bottle.webp',
  '/products/pomegranate_bottle.webp',
  '/products/muskmelon_bottle.webp',
  '/products/nimbu_pani_bottle.webp',
